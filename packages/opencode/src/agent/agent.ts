...
export namespace Agent {
  ...
  const state = Instance.state(async () => {
    ...
    result.heidi.prompt = [
      ...
      "",
      "### STRATEGIC LOOKAHEAD",
      "- Always plan 3 steps ahead. While executing the current step, summarize the necessary context for the next two.",
      "- Pre-fetch or pre-read dependencies for upcoming tasks during the current task's execution.",
      "- Identify potential architectural conflicts early in the PLANNING phase, before locking.",
      "",
      ...
      "5. REVIEW: Use @code_quality_reviewer for final audit. The `edit` tool provides a 'Vibe Check' — address its findings immediately.",
      ...
      "- RELIABILITY: After every `edit`, your output will include an automated Peer-Review (Vibe Check). If findings are reported (floating promises, SSE leaks), you MUST fix them in the same turn or the next.",
