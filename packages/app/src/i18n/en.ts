export const dict = {
  ...
  "command.copilot.open": "Open Copilot builder",
  "command.copilot.open.description": "Open the Spark-style builder workspace",
  ...
  "copilot.page.badge": "Spark-equivalent preview",
  "copilot.page.title": "Build full-stack apps with GitHub Copilot",
  "copilot.page.body": "Shape the UI, wire the backend, publish a share link, and stage a VPS deploy from one builder workspace.",
  "copilot.page.cta.connect": "Connect GitHub Copilot",
  "copilot.page.cta.session": "Open session",
  "copilot.page.hero.connection": "Connection",
  "copilot.page.hero.project": "Project",
  "copilot.page.hero.deploy": "Deploy target",
  "copilot.page.hero.sessions": "Sessions",
  "copilot.page.hero.tokens": "Tokens",
  "copilot.page.tab.build": "Build",
  "copilot.page.tab.preview": "Preview",
  "copilot.page.tab.publish": "Publish",
  "copilot.page.tab.deploy": "Deploy",
  "copilot.page.summary.title": "Live Copilot summary",
  "copilot.page.summary.subtitle": "These values come from the current project and the real GitHub Copilot provider state on the server.",
  "copilot.page.summary.loading": "Loading Copilot summary...",
  "copilot.page.summary.empty": "No usage yet",
  "copilot.page.metric.models": "Models",
  "copilot.page.metric.messages": "Messages",
  "copilot.page.metric.tokens": "Tokens",
  "copilot.page.metric.cost": "Cost",
  "copilot.page.metric.defaultModel": "Default model",
  "copilot.page.metric.topModel": "Top model",
  "copilot.page.metric.default": "Default",
  "copilot.page.build.title": "Builder prompt",
  "copilot.page.build.subtitle": "Seed the first full-stack pass, then keep shaping the product from one lane-based workspace.",
  "copilot.page.build.status": "Ready",
  "copilot.page.build.prompt.label": "What should this app become?",
  "copilot.page.build.prompt.placeholder": "Create a multi-tenant customer portal with AI-assisted support, billing, and deployment checks.",
  "copilot.page.build.lanes": "Execution lanes",
  "copilot.page.build.models": "Available Copilot models",
  "copilot.page.build.modelsSubtitle": "Live inventory from the connected provider in this project.",
  "copilot.page.build.modelsEmpty": "Connect GitHub Copilot to load model inventory for this project.",
  "copilot.page.build.lane.prompt": "Prompt and planning lane for shaping the product brief, UX goals, and delivery constraints.",
  "copilot.page.build.lane.code": "Code lane for coordinated frontend and backend changes against the same app state.",
  "copilot.page.build.lane.preview": "Preview lane for visual iteration, annotations, and quick validation before publishing.",
  "copilot.page.build.lane.deploy": "Deploy lane for VPS targeting, health checks, and rollback-aware release operations.",
  "copilot.page.preview.title": "Live preview",
  "copilot.page.preview.subtitle": "A bold visual surface for instant iteration, annotations, and direct code edits.",
  "copilot.page.preview.live": "Live surface",
  "copilot.page.preview.label": "Hot view",
  "copilot.page.preview.mockTitle": "Customer operations cockpit",
  "copilot.page.preview.blockA": "Fast annotations",
  "copilot.page.preview.blockABody": "Click a region, describe the change, and keep the builder anchored to the current UI state.",
  "copilot.page.preview.blockB": "Backend-aware UI",
  "copilot.page.preview.blockBBody": "Preview cards are meant to reflect real endpoints, auth states, and deploy health instead of static mocks.",
  "copilot.page.preview.annotations": "Annotation-ready flow",
  "copilot.page.preview.annotationsBody": "The next slice will attach highlight-based edit requests and live preview refreshes to this panel.",
  "copilot.page.publish.title": "Publish surface",
  "copilot.page.publish.subtitle": "Ship a shareable app URL, keep updates flowing, and preserve a clean handoff into repo-backed workflows.",
  "copilot.page.publish.empty": "No published builder session yet",
  "copilot.page.publish.pending": "Publishing workflow running...",
  "copilot.page.publish.action.publish": "Publish latest session",
  "copilot.page.publish.action.unpublish": "Unpublish session",
  "copilot.page.publish.action.open": "Open published session",
  "copilot.page.publish.session": "Latest root session",
  "copilot.page.publish.toast.success": "Builder session published",
  "copilot.page.publish.toast.unpublished": "Builder session unpublished",
  "copilot.page.publish.toast.failed": "Builder publish failed",
  "copilot.page.publish.list": "Publishing rules",
  "copilot.page.publish.item.private": "Default to private visibility with explicit publish and unpublish controls.",
  "copilot.page.publish.item.updates": "Keep a stable public URL while letting the builder issue update pushes.",
  "copilot.page.publish.item.repo": "Expose the repo and session handoff as first-class follow-up actions.",
  "copilot.page.deploy.title": "VPS deploy draft",
  "copilot.page.deploy.subtitle": "Stage the Docker Compose deployment flow with one-time credentials and health-aware rollout state.",
  "copilot.page.deploy.host": "Host",
  "copilot.page.deploy.publicPort": "Public port",
  "copilot.page.deploy.user": "Username",
  "copilot.page.deploy.password": "Password",
  "copilot.page.deploy.path": "Deploy path",
  "copilot.page.deploy.note": "This workflow runs on the backend over live SSH, uploads a Docker Compose landing page, and starts it on the target VPS without persisting your password in app state.",
  "copilot.page.deploy.pending": "Deploying to VPS...",
  "copilot.page.deploy.action.run": "Deploy to VPS",
  "copilot.page.deploy.action.open": "Open deployment",
  "copilot.page.deploy.logs": "Deployment logs",
  "copilot.page.deploy.toast.success": "VPS deployment completed",
  "copilot.page.deploy.toast.failed": "VPS deployment failed",
  "copilot.page.deploy.list": "Deploy pipeline",
  "copilot.page.deploy.connected": "Provider state: {{status}}",
  "copilot.page.deploy.item.compose": "Generate Docker Compose assets for the app, runtime env, and service topology.",
  "copilot.page.deploy.item.logs": "Stream remote logs and health checks back into the builder after bootstrap.",
  "copilot.page.deploy.item.rollback": "Keep redeploy and rollback actions close to the active deploy target.",
  ...
  "settings.copilot.title": "Copilot Builder",
  "settings.copilot.subtitle": "Connect GitHub Copilot, review builder readiness, and jump into the Spark-equivalent workspace.",
  "settings.copilot.status.connected": "GitHub Copilot connected",
  "settings.copilot.status.disconnected": "GitHub Copilot disconnected",
  "settings.copilot.status.empty": "No Copilot account connected yet",
  "settings.copilot.models": "{{count}} models available in this project",
  "settings.copilot.lastUsed": "Last activity",
  "settings.copilot.lastUsed.empty": "No Copilot usage yet for this project",
  "settings.copilot.metric.models": "Models",
  "settings.copilot.metric.sessions": "Sessions",
  "settings.copilot.metric.messages": "Messages",
  "settings.copilot.metric.tokens": "Tokens",
  "settings.copilot.routeHint": "Builder route:",
  "settings.copilot.cta.connect": "Connect GitHub Copilot",
  "settings.copilot.cta.reconnect": "Reconnect GitHub Copilot",
  "settings.copilot.cta.open": "Open builder",
  "settings.copilot.feature.build": "Prompt-to-app orchestration for frontend and backend from a single builder lane.",
  "settings.copilot.feature.preview": "Live preview and annotation-ready UI iteration instead of one-shot code generation.",
  "settings.copilot.feature.publish": "Publish-aware app state with a clear bridge into share URLs and repo workflows.",
