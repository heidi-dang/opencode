export const dict = {
  ...
  "copilot.page.deploy.note": "This first slice keeps deployment local to the page state. The next backend slice will switch these fields to an ephemeral, non-persisted deploy session.",
